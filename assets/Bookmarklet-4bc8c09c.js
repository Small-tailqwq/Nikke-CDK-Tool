import{_ as u}from"./index-34dcfd54.js";import{f as g,w as f,h as v}from"./element-plus-4e0f0651.js";import{r as x,c as y,y as b,z as C,A as o,M as n,Q as l,I as c}from"./vue-85abc9fb.js";import"./axios-3a665b0f.js";const h={class:"page"},S=["href"],w={class:"actions"},I={__name:"Bookmarklet",setup(L){const d=`(() => {
  try {
...
})();`,i=x(d),r=y(()=>"javascript:"+encodeURIComponent(i.value));function p(){const s="https://www.blablalink.com/login?to=/cdk",e="https://www.blablalink.com/cdk";let t=null;try{t=window.open(s,"nikkeLoginWin")}catch{}if(!t){location.assign(s);return}const a=setInterval(()=>{t&&t.closed&&(clearInterval(a),location.assign(e))},500);setTimeout(()=>clearInterval(a),18e4)}async function _(){await navigator.clipboard.writeText("javascript:"+i.value)}return(s,e)=>{const t=g,a=v,k=f;return b(),C("div",h,[e[7]||(e[7]=o("h2",null,"官方登录助手",-1)),o("ol",null,[o("li",null,[e[1]||(e[1]=n(" 将下方按钮拖到浏览器书签栏，或右键复制链接添加为书签： ")),o("a",{href:r.value,class:"bookmarklet"},"NIKKE 登录回传",8,S)]),e[2]||(e[2]=o("li",null," 点击“前往官方登录页”，在新开的登录页完成登录（可能被拦截则会在本标签打开）。 登录完成后可直接关闭登录页。 ",-1)),e[3]||(e[3]=o("li",null,[n(" 登录页关闭后，你当前这个标签会自动前往官方 "),o("code",null,"/cdk"),n(" 页面。 在该页面点击书签 “NIKKE 登录回传”。 ")],-1)),e[4]||(e[4]=o("li",null," 页面将回到本工具的“登录回调”页，查看信息卡片并选择“更新此用户的Cookie”或“创建并保存”。 ",-1))]),o("div",w,[l(t,{type:"primary",onClick:p},{default:c(()=>e[5]||(e[5]=[n("前往官方登录页")])),_:1,__:[5]}),l(t,{onClick:_},{default:c(()=>e[6]||(e[6]=[n("复制书签脚本")])),_:1,__:[6]})]),l(a,{type:"info",closable:!1,title:"安全与使用说明",description:"脚本仅在官方站点读取与兑换相关的少量 cookie/localStorage 字段，并通过 URL hash 回传至本工具，不会外发到第三方服务器；本页面不会关闭你的当前标签。若弹窗被拦截，将在本标签直接打开登录页；若未自动跳转到 /cdk，可手动访问官方 /cdk 再点击书签。"}),e[8]||(e[8]=o("h3",null,"调试信息",-1)),l(k,{type:"textarea",autosize:{minRows:6},modelValue:i.value,"onUpdate:modelValue":e[0]||(e[0]=m=>i.value=m)},null,8,["modelValue"])])}}},V=u(I,[["__scopeId","data-v-4e6e79a7"]]);export{V as default};
