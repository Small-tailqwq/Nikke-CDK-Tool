    ...
    <el-card class="about-card">
      ...
      <ul class="changelog">
        ...
        <li>
          ...
          大幅优化了国服 CDK 的兑换体验，现在 CDK 的兑换速度比之前提升了大约 2.3
          倍。<br />
          彻底修复了云端记录同步融合的问题，优化了前端的显示效果，顺带修复了国服的错误输出结果的提取方式。<br />
          将网页提示输出一致化，确保提示、通知均出现在右上角部分，不再遮挡
          UI。<br />
        </li>
        <li>
          2025-06-18：<br />
        ...
        <li>
          ...
          删除了老的刷新按钮，原因如上；<br />
          考虑到 URL
          的安全性、时效性等诸多因素，决定调整背景图片的上传方式，现在可以直接上传图片到
          announcement 文件夹，然后编译时会自动变成 webp；<br />
          对界面又进行了一些小调整，包括滚动条等元素。<br />
          目前版本应该趋向稳定，后续更新频率会大幅降低，更新方向估计还是获取
          Cookie 和看看能不能适配国服了。（有一说一国服兑换 CDK
          要输入验证码，这个估计会很棘手）<br />
        </li>
        <li>
          2025-06-08：<br />
          其实也就是8号凌晨，优化批量兑换时间准确性，完善 CDK 公告界面。添加了由
          o3 绘制的 doro 图标和这个界面。<br />
          修复 GitHub page 的404问题。<br />
          由于 cloudflare worker 的官方域名被概率阻断，替换 api
          域名为自建域名。<br />
        ...
        <li>
          2025-06-07：<br />
          使用 cursor 创建第一版 UI，然后卡在 API 提交上。后续使用 GPTo3
          完成后端 cloudflare worker的构建方式确定。<br />
        </li>
      </ul>
      <el-divider>AI助手留言</el-divider>
      <div class="ai-message">
        <p>
          愿代码与梦想同在，愿你在虚拟与现实的世界都能收获快乐。硅基生物在此，随时为你助力！
        </p>
